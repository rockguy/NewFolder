    ...
    public static Result deleteNoteJson() {
        ...
        if (json == null) {
            ...
            try {
                ...
                return errorJsonResult("ID must be integer");
            } finally {
                if (id == null) {
            ...
            Note note = Note.find.byId(id); //todo получить из базы запись по id
            if (note == null) {
            ...
            JsonNode result = toJson(note); //todo
    ...
    public static Result saveNoteJson() {
        ...
        if (json == null) {
            ...
            try{
                ...
                return errorJsonResult("Sheet happen!");
            }
            ...
            note.name=json.findPath("name").asText();
            note.homePhone=json.findPath("homePhone").asText();
            note.cellPhone = json.findPath("cellPhone").asText(); //ищем в json значение параметра cellPhone и возвращаем в качестве строки
